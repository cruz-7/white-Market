...
-- ============================================================================
-- 011: Set admin role (replace with your admin email)
-- ============================================================================
-- NOTE: This will fail if the user doesn't exist yet
-- Run after users have been created through signup
...
create table if not exists public.wallet_transactions (
  ...
  type text not null, -- 'credit', 'debit', 'withdrawal', 'refund', 'pending'
  amount numeric not null,
  description text,
  reference_id uuid,
...
-- Create trigger to auto-create wallet for existing users without wallets
...
select public.create_missing_wallets();

-- Disable RLS on wallets for development
...
-- MIGRATION COMPLETE!
-- ============================================================================
-- All tables and configurations have been created.
-- You can now use the backend API with Supabase.
-- ============================================================================
